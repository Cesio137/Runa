...
GameUserSettings::GameUserSettings()
{
    ...
    ContextMenuFontPath.append(Dir::nativeSeparator("assets/Fonts/Fira_Code/ttf/FiraCode-SemiBold.ttf"));
    ...
    DefaultFontPath.append(Dir::nativeSeparator("assets/Fonts/Fira_Code/ttf/FiraCode-Medium.ttf"));
