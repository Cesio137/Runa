...
const char * LIB_PATH_VALUE   = "C:\\msys64\\home\\natha\\gettext-0.22.3\\build\\gettext-runtime\\intl\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\msys64\\mingw64\\lib;C:\\msys64\\mingw64\\bin;C:\\msys64\\home\\natha\\gettext-0.22.3\\build\\gettext-runtime\\intl\\.libs;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' ../intl/libintl.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"envsubst.exe:envsubst:$LINENO: libtool wrapper (GNU libtool) 2.4.7\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("    PATH=/mingw64/lib:/mingw64/bin:/home/natha/gettext-0.22.3/build/gettext-run", f);
  fputs ("time/intl/.libs:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/natha/gettext-0.22.3/build/gettext-runtime/intl/.libs:$PATH\"\n", f);
  fputs ("\n", f);
